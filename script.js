...
function startUp() {
  ...
  messageText.innerHTML = "This software has been developed solely for educational and research purposes, aiming to test the vulnerabilities of computer monitoring software ONLY under a personal environment, on a personal device, and seperate from any overarching systems of authority. The development, testing, and any other use of this software took place on a personal device, network, and environment. It is not intended for any malicious or unauthorized use, and its usage on school devices, within a school network, or in any environment involving any software, hardware, or property belonging to CFB-ISD or it's components is strictly prohibited.<br><br><br><br> By using this software, you agree to abide by all applicable terms and rules. The developer assumes no responsibility for any misuse or unauthorized activities conducted using this software. The developer disclaims any liability for any consequences arising from the use of this software which is in violation of the Carrollton-Farmers Branch ISD rules and regulations. Upon clicking the button below, you agree to all of the above terms.";
...
function chromeGetter() {
    ...
    Object.defineProperty(div, "id", {
      get: () => { 
        alert("Sorry, no debugging for you!"); 
        exit()
      }
    });
...
function call1() {
  if ('#call1call2call3call4' !== getCallStack()) {
    alert("Sorry, no debugging for you!"); 
    exit()
  } 
}
