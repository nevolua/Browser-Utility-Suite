...
const tabsCSS            = 'width:100px;height:300px;background-color:rgba(0,0,0, 1);border-radius:10px;position:absolute;top:50%;left:0;transform:translateY(-50%); font-size: 0; text-align: center;border-bottom-right-radius: 0px;border-right: 1px solid white;';
const contentCSS         = 'width:500px;height:300px;background-color:black;border-radius:10px 0px 10px 0px;position:absolute;top:50%;right:0;transform:translateY(-50%);overflow-y:scroll;max-height: 300px;overflow-y: auto;text-align:center;border-top:none;::-webkit-scrollbar { width: 0px; background-color: transparent; }; background-size: 200% 200%; box-shadow: 0 0 10px rgba(0, 0, 0, 0.5);border-top-left-radius: 0px;'; 
